/*
    ...
    Low-level graphics module using GGI, version 0.3 (25-02-2001).
...
#define THROW(e)            { non_fatal(e,GETMSG(e),c); return; }
    ...
    switch( num ) {
        ...
        case SYSCALL_GGI_OPEN:
               ...
               Output: u0 - visual ID */
            {
                ...
                namelen   = UREG(2);
                accesslen = UREG(2) + strlen( "ggi/visual/" );
        ...
        case SYSCALL_GGI_PUTC:
            ...
            SREG(0) = ggiPutc( visuals[UREG(0)]->v_real,
                               SREG(1), SREG(2), UREG(1) );
